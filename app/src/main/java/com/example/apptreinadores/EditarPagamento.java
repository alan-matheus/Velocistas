...
public class EditarPagamento extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra("pagamento")) {
            pagamento = (Pagamento) intent.getSerializableExtra("pagamento");
            preencherCampos();
        } else {
            // Se não houver objeto Pagamento, encerrar a atividade
            finish();
        }
        ...
        binding.btnVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EditarPagamento.this, ListarPagamentos.class);
    ...
    private void preencherCampos(){
        binding.inputValorPagamento.setText(Double.toString(pagamento.getValor()));
        binding.inputDataPagamento.setText(pagamento.getData());
    }
    ...
    private void atualizarPagamento(){
        ...
        dbHelper.editarPagamento(pagamento);

        Toast.makeText(this, "Pagamento editado com sucesso!", Toast.LENGTH_LONG).show();
        limparCampos();
        Intent intent = new Intent(EditarPagamento.this, ListarPagamentos.class);
        intent.putExtra("cavalo", cavalo);
        intent.putExtra("cavaloId", cavaloId);
